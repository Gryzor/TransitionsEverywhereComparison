...
public class AndroidTransitionsChangeColor extends Transition {
    ...
    public AndroidTransitionsChangeColor(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }

    public AndroidTransitionsChangeColor() {
        super();
    }
