...
// SOURCE TAKEN FROM: https://developer.android.com/samples/CustomTransition/src/com.example.android.customtransition/ChangeColor.html

public class TransitionsEverywhereChangeColor extends Transition {
    ...
    public TransitionsEverywhereChangeColor(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }

    public TransitionsEverywhereChangeColor() {
        super();
    }
